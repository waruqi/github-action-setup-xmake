    ...
    if (!toolDir) {
        const installer = await core.group(`download xmake ${version}`, async () => {
            ...
            if (version.startsWith("branch@")) {
                ...
                url = `https://ci.appveyor.com/api/projects/waruqi/xmake/artifacts/xmake-installer.exe?branch=${sha}&pr=false&job=Image%3A+Visual+Studio+2013%3B+Platform%3A+${arch}`;
            }
            else {
